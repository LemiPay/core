...
use crate::application::settlements::claim::dto::ClaimInput;
...
use crate::interfaces::http::core::dto::{
    ClaimRequest, ClaimResponse, GetSettlementsResponse, PaySettlementRequest,
...
pub async fn claim(
    ...
    let result = state.settlements_service.claim.execute(input)?;
    let tx = result.transaction;
