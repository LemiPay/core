...
use handlers::{
    ...
    list_approved_proposals, list_group_investments, list_strategies, withdraw_investment,
};
...
pub fn routes(state: SharedState) -> Router<SharedState> {
    Router::new()
        ...
        .route(
            "/proposals/{group_id}",
            get(list_approved_proposals).route_layer(middleware::from_fn_with_state(
                state.clone(),
